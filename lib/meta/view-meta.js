...
// ViewMeta.findFixed = (doc, keys, params, callback) => {
//     ViewMeta.find(doc.constructor, doc.id, keys, params, callback);
// }

// ViewMeta.find = (Model, keys, params, callback) => {
//     const paramsClone = Object.assign({}, params, { include_docs: true });
...
//     Model.db.view('_couch_recliner', name, params, (err, result) => {
//         if (err && tries <= 1 && (err.name === 'no_db_file' || err.name === 'not_found')) {
//             const view = {
//                 map: ViewBuilder.mapFunction(keys, values)
//             };
//             _updateCouchReclinerDesign(Model, name, view, (err) => {
//                 if (err)
...
// function _updateCouchReclinerDesign(Model, name, view, callback) {
...
//     DocMeta.updateOrWrite(Model, '_design/_couch_recliner', body, callback);
// }
