...
class Doc {
    constructor(db, body = {}, result = {}) {
        this.body = {};
        this.db = db;
        this.attachment = new DocAttachment.default(this);
    ...
    _performRead(callback) {
        this.db.raw.get(this.getId(), Err.default.resultFunc('doc', callback));
    }
    write(body, callback = () => { }) {
        if (!this.getId())
            callback(Err.default.missingId('doc'));
    ...
    _performWrite(body, callback) {
        ...
        this.db.raw.insert(body, this.getId(), Err.default.resultFunc('doc', callback));
    }
    ...
    _performUpdate(body, callback) {
        if (this.getRev() !== this._latestRev)
            callback(Err.default.conflict('doc')); // we know we are out of date
        else
            this.db.raw.insert(body, this.getId(), Err.default.resultFunc('doc', callback));
    }
    destroy(callback = () => { }) {
    ...
    _performDestroy(callback) {
        this.db.raw.destroy(this.getId(), this._latestRev, Err.default.resultFunc('doc', callback));
    }
    head(callback = () => { }) {
        if (!this.getId())
            callback(Err.default.missingId('doc'));
